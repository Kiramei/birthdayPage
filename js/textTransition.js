...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate(__name__+'|祝你|生日|快乐')
      setTimeout(() =>
        setInterval(() =>
          S.UI.simulate(__name__+'|祝你|生日|快乐'),
          4000)
...
S.ShapeBuilder = (function () {
  var gap = window.innerWidth > horizon ? 13 : 6,
  ...
  function processCanvas() {
    ...
    for (var p = 0; p < pixels.length * 4; p += amount) {
      if (pixels[p + 3] > 0) {
    ...
    switchShape: function (n, fast) {
      ...
      while (n.dots.length > 0) {
        ...
        dots[d].move(new S.Point({
          ...
          y: n.dots[i].y + cy,
          a: 1,
          z: window.innerWidth > horizon ? 5 : 3,
          h: 0
        }));
